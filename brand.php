...
<div class="row">
	<div class="col-md-12">
		...
		<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<button class="btn btn-primary button1" data-toggle="modal" data-target="#addBrandModel"> <i class="glyphicon glyphicon-plus-sign"></i> Ajoute Une Marque </button>
				</div> <!-- /div-action -->		
		<div class="panel panel-primary">
			<div class="panel-heading">
				<div class="page-heading"> <i class="glyphicon glyphicon-edit"></i> Gérer la Marque</div>
			</div> <!-- /panel-heading -->
			<div class="panel-body">
				...
				<table class="table table-hover table-bordered table-striped table-outline mb-0 nowrap text-center" id="manageBrandTable" width="100%" cellspacing="0">
    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitBrandForm" action="php_action/createBrand.php" method="POST">
	      <div class="modal-header btn-primary">
	        ...
	        <h4 class="modal-title"><i class="fa fa-plus"></i> Ajoute Une Marque</h4>
	      </div>
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="submit" class="btn btn-primary" id="createBrandBtn" data-loading-text="Loading..." autocomplete="off">Enregistre</button>
	      </div>
	      <!-- /modal-footer -->
     	</form>
	     <!-- /.form -->
    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="editBrandForm" action="php_action/editBrand.php" method="POST">
	      <div class="modal-header btn-warning">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title"><i class="fa fa-edit"></i> Miodifier</h4>
	      </div>
	      <div class="modal-body">
	      ...
	      <div class="modal-footer editBrandFooter">
	        ...
	        <button type="submit" class="btn btn-warning" id="editBrandBtn" data-loading-text="Loading..." autocomplete="off"> <i class="glyphicon glyphicon-ok-sign"></i> Sauvegarder les modifications</button>
	      </div>
	      <!-- /modal-footer -->
     	</form>
	     <!-- /.form -->
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeMemberModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Voulez-vous vraiment supprimer cette Marque :<b> <span id="supprimer"></span> </b> ?</p>
      </div>
      <div class="modal-footer removeBrandFooter">
        ...
        <button type="button" class="btn btn-danger" id="removeBrandBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-trash"></i> Supprime</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
