...
// Create new PDF
   ...
   // ----- ------------------ ------------ Savoinor  TVA  ------------------------ --->
    $sql = "SELECT * FROM orders WHERE order_date >= '$start_date' AND order_date <= '$end_date' and order_status = 1 AND factureTva=11 AND  agenceId = $productStatusClient GROUP BY numeroFacture";
...
$table .=' <tr>
                ...
                <td rowspan="'. $lineRow.'">'.$result['client_name'].' - '.$result['client_contact'].'</td>';
